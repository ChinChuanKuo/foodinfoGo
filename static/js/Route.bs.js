...
import * as Carte$BtsCore from "./pages/Carte/Carte.bs.js";
import * as Login$BtsCore from "./pages/Login/Login.bs.js";
import * as Oauth$BtsCore from "./pages/Oauth/Oauth.bs.js";
import * as Store$BtsCore from "./pages/Store/Store.bs.js";
...
import * as Busdate$BtsCore from "./pages/Busdate/Busdate.bs.js";
import * as Fesdate$BtsCore from "./pages/Fesdate/Fesdate.bs.js";
      ...
      switch (match$1[0]) {
        ...
        case "busdate" :
            if (match$1[1]) {
              ...
              tmp = React.createElement(Busdate$BtsCore.make, { });
            }
            break;
        case "carte" :
            if (match$1[1]) {
              ...
              tmp = React.createElement(Carte$BtsCore.make, { });
            }
            break;
        case "fesdate" :
            if (match$1[1]) {
              ...
              tmp = React.createElement(Fesdate$BtsCore.make, { });
            }
            break;
        case "icon" :
            if (match$1[1]) {
        ...
        case "store" :
            if (match$1[1]) {
              ...
              tmp = React.createElement(Store$BtsCore.make, { });
            }
            break;
        default:
          exit$1 = 2;

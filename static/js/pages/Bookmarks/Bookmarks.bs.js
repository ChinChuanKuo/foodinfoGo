...
function Bookmarks(Props) {
  var storeForm = React.useCallback((function (param) {
          Axiosapi$BtsCore.Default.store(Data$BtsCore.userData(localStorage.getItem("newid"))).then((function (response) {
                    var match = response.data.status;
                    var tmp;
                    if (match === "istrue") {
                      tmp = ReasonReactRouter.push(Path$BtsCore.storePath + ("#" + response.data.formId));
                    } else {
